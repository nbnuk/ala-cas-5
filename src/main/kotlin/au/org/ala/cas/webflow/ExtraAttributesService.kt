...
//                throw e
    ...
    fun surveyOptions(locale: Locale): Map<String, String> {
        ...
        return linkedMapOf(
                //NBN replace user types to align with userdetails
...
//            "disinclinedToAcquiesce" to messageSource.getMessage("ala.affiliations.disinclinedToAcquiesce", args, "Prefer not to say", locale)
            "" to "-- Please select --",
            "Academia and research" to "Academia and research",
            "Agriculture, forestry and fishing" to "Agriculture, forestry and fishing",
            "Artist, journalist, photographer" to "Artist, journalist, photographer",
            "College and university student" to "College and university student",
            "Construction, utilities and technology" to "Construction, utilities and technology",
            "Ecologist" to "Ecologist",
            "Environmental consultant" to "Environmental consultant",
            "LERC staff" to "LERC staff",
            "Local and national government" to "Local and national government",
            "Museums, botanical gardens and aquaria" to "Museums, botanical gardens and aquaria",
            "NGO staff" to "NGO staff",
            "Personal interest" to "Personal interest",
            "Recorder and recording scheme" to "Recorder and recording scheme",
            "Teaching and education" to "Teaching and education"
        )
    }
